...
`define     IR_csr          31:20
`define     OPCODE_Branch   5'b11_000 // done
`define     OPCODE_Load     5'b00_000 // done
`define     OPCODE_Store    5'b01_000// done
`define     OPCODE_JALR     5'b11_001//done
`define     OPCODE_JAL      5'b11_011// done
`define     OPCODE_Arith_I  5'b00_100//done
`define     OPCODE_Arith_R  5'b01_100//done
`define     OPCODE_AUIPC    5'b00_101 //done
`define     OPCODE_LUI      5'b01_101
`define     OPCODE_SYSTEM   5'b11_100//done 
...
`define     ALU_MUL         4'b00_10 // MUL
`define     ALU_DIV         4'b01_10 // DIV
`define     ALU_REM         4'b1011 // REM
